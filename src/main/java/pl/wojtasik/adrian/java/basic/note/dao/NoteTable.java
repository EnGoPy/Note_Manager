...
public class NoteTable {
    ...
    public static final String PATH = "jdbc:h2:~/test";
    ...
    public static final String FIND_NOTE_BETWEEN = "SELECT " + NOTE_COLUMN_TITLE + " FROM " + NOTE_TABLE_NAME + " WHERE " + NOTE_COLUMN_TITLE + " BETWEEN ? AND ?";
